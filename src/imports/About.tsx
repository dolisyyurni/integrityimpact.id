...
export default function About({ onNavigate }: AboutProps) {
  return (
    <div className="bg-white relative w-full min-h-[950px]" data-name="About">
      <div className="absolute blur-[5px] filter h-[1172px] left-[-103px] top-0 w-[1542px]" data-name="portrait-young-man-topless-use-bamboo-fishing-trap-catch-fish-cooking-asian-young-farmer-man-rural-lifestyle 2">
      ...
      <div className="absolute bg-black h-[145px] left-[78px] opacity-40 rounded-[20px] top-[752px] w-[1292px]" />
      ...
      <div className="absolute font-['Poppins:Regular',sans-serif] leading-[normal] not-italic right-[71px] text-[18px] text-right text-shadow-[5px_5px_3px_rgba(0,0,0,0.25)] text-white top-[261px] w-[847px]">
        <p className="mb-0">
          <span>{`Perkembangan teknologi digital membuka peluang besar bagi transformasi sosial yang lebih `}</span>
          <span className="font-['Poppins:Bold',sans-serif] not-italic">transparan, inklusif, dan berkelanjutan</span>
          <span>{`. Namun, banyak inisiatif pemberdayaan pemuda dan kewirausahaan sosial masih `}</span>
          <span className="font-['Poppins:Bold',sans-serif] not-italic">terjebak pada pendekatan konvensional</span>
          <span>{` yang berorientasi `}</span>
          <span className="font-['Poppins:Bold',sans-serif] not-italic">jangka pendek, minim transparansi</span>
          <span>{`, serta belum menjadikan integritas sebagai fondasi utama. Akibatnya, berbagai program sosial kehilangan keberlanjutan, kepercayaan publik, dan dampak nyata bagi masyarakat. Menjawab tantangan tersebut, gagasan integrityimpact.id hadir sebagai sebuah platform digital yang dirancang untuk membangun `}</span>
          <span className="font-['Poppins:Bold',sans-serif] not-italic">ekosistem kewirausahaan sosial</span>
          <span>{` pemuda`}</span>
          <span className="font-['Poppins:Bold',sans-serif] not-italic">{` berbasis integritas dan dampak sosial`}</span>.
        </p>
        <p>&nbsp;</p>
      </div>
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[normal] not-italic right-[71px] text-[18px] text-right text-shadow-[5px_5px_3px_rgba(0,0,0,0.25)] text-white top-[507px] w-[847px]">
        <span className="font-['Poppins:Bold',sans-serif]">integrityimpact.id</span>
      ...
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[normal] not-italic right-[715px] text-[18px] text-center text-shadow-[5px_5px_3px_rgba(0,0,0,0.25)] text-white top-[769px] translate-x-[50%] w-[1246px]">
        <span>{`Secara konseptual, integrityimpact.id dirancang untuk mendukung pencapaian `}</span>
        <span className="font-['Poppins:Bold',sans-serif]">Tujuan Pembangunan Berkelanjutan (SDGs)</span>
        <span>{` serta visi `}</span>
        <span className="font-['Poppins:Bold',sans-serif]">Indonesia Emas 2045,</span>
      ...
      <p className="absolute font-['Hannari:Regular','Noto_Sans:Regular',sans-serif] leading-[normal] left-[1116px] text-[30px] text-nowrap text-white top-[173px]" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 400" }}>
        LATAR BELAKANG
      </p>
    </div>
  );
